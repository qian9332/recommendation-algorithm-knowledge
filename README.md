...
### 📝 面试题大全
- [十九、推荐算法工程师面试题大全](docs/19-interview-questions.md)
- [二十、高阶推荐算法面试题](docs/20-advanced-interview-questions.md)
- [二十一、专家级推荐算法面试题](docs/21-expert-interview-questions.md) ⭐新增
...
| 模块 | 核心内容 |
|-----|---------|
| **系统设计类** | 千万级DAU推荐系统设计、实时推荐系统设计 |
| **算法原理深度** | 多目标优化、序列建模方法比较 |
| **工程实践** | 特征工程最佳实践、模型部署更新策略 |
| **业务场景** | 短视频推荐系统设计 |
| **前沿技术** | 大语言模型在推荐系统中的应用 |
